(function () {
    ...
    function UserStartNodesEditController($scope, $routeParams, userStartNodesResource, notificationsService, navigationService) {
        var vm = this;
    ...
    angular.module("umbraco").controller('UserStartNodes.EditController', UserStartNodesEditController);
